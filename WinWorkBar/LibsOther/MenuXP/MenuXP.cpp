...
bool CMenuItem::GetDisabled () const
{
	...
	if (((GetMenuState(m_hMenuSave, m_uItemSave, m_fByPositionSave) & MF_GRAYED)== MF_GRAYED))
		bDisabled = true;
	if ((m_miInfo.fState & MFS_GRAYED) == MFS_GRAYED)
		bDisabled = true;
	return bDisabled;
}
